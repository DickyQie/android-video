...
import com.zhangqie.videosummary.util.ScreenUtils;
...
public class CircleProgressButton extends View {
    ...
    private final int DEFAULT_IDLE_CIRCLE_COLOR = getResources().getColor(R.color.colorAccent);
    private final int DEFAULT_PRESSED_CIRCLE_COLOR = getResources().getColor(R.color.coclorN);
    private final int DEFAULT_RELEASED_CIRCLE_COLOR = DEFAULT_IDLE_CIRCLE_COLOR;

    private final int DEFAULT_IDLE_RING_COLOR = getResources().getColor(R.color.coclorN);
