...
public class ZQUtils {
    ...
    public static void setRequestedOrientation(Context context, int orientation) {
        if (ZQUtils.getAppCompActivity(context) != null) {
            ZQUtils.getAppCompActivity(context).setRequestedOrientation(
                    orientation);
        } else {
            ZQUtils.scanForActivity(context).setRequestedOrientation(
                    orientation);
        }
    }
    ...
    public static Window getWindow(Context context) {
        if (ZQUtils.getAppCompActivity(context) != null) {
            return ZQUtils.getAppCompActivity(context).getWindow();
        } else {
            return ZQUtils.scanForActivity(context).getWindow();
        }
    }
    ...
    public static void saveProgress(Context context, Object url, int progress) {
        if (!ZQVideoPlayer.SAVE_PROGRESS) return;
    ...
    public static int getSavedProgress(Context context, Object url) {
        if (!ZQVideoPlayer.SAVE_PROGRESS) return 0;
